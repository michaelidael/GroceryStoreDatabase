...
INSERT INTO `citystate` VALUES ('Piscataway','NJ','08854'),('Lanham','MD','20706'),('Abingdon','VA','24210'),('Clover','SC','29710'),('Duluth','GA','30096'),('Jupiter','FL','33458'),('Nashville','TN','37205'),('Nashville','TN','37285'),('Memphis','TN','38117'),('Willoughby','OH','44094'),('Cuyahoga Falls','OH','44223'),('Battle Creek','MI','49016'),('Jefferson','LA','70121'),('Covington','LA','70433'),('Scottsdale','AZ','85260'),('Ontario','CA','91764'),('San Marcos','CA','92078'),('Huntington Beach','CA','92647');
...
CREATE TABLE `customerpayment` (
  ...
  CONSTRAINT `customerpayment_chk_1` CHECK ((`total` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product` VALUES (1,'lamb shank',1,' lamb shank in rosemary and mint sauce',' 10 ounce',20,9.99),(2,'veal',1,' veal osso buco',' 15.5 ounce',15,11.99),(3,'short rib',1,' braveheart angus beef boneless short rib',' 12 ounce',40,7.99),(4,'flank steak',1,' braveheart angus beef flank steak',' 2 pound',30,16.99),(5,'chicken',1,' boneless chicken breasts',' 8 count',56,21.99),(6,'pork chops',1,' bacon-wrapped pork chops',' 4 count',42,19.99),(7,'langoustines',2,' medium wild langoustines',' 7 count',25,20.99),(8,'octopus',2,' cooked small octopus tentacles',' 3 count',15,23.00),(9,'shrimp',2,' red shrimp from argentina XL',' 12 count',50,12.99),(10,'clams',2,' coquina clams',' 12 count',45,9.99),(11,'peas',3,' extra fine french peas',' 2 pound',60,5.99),(12,'artichoke',3,' artichoke bottoms',' 2 pound',24,17.69),(13,'bean',3,' very find yellow wax beans',' 2 pound',30,6.29),(14,'broccoli',3,' broccoli florets',' 2 pound',55,4.49),(15,'potatoes',3,' family size smashed red potatoes',' 32 ounce',55,12.99),(16,'potatoes',3,' family size whipped sweet potatoes',' 32 ounce',55,14.49),(17,'potatoes',3,' potatoes au gratin',' 3 ounce',55,8.49),(18,'rice',4,' jasmine rice',' 2 pound',45,9.99),(19,'rice',4,'brown red and wild rice medley','2 pound',35,9.99),(20,'quinoa',4,'organic quinoa','2 pound',26,12.99),(21,'lentils',4,'black beluga lentils','2 pound',26,12.99),(22,'pastry',5,'frangipane king cake','19 ounce',32,19.99),(23,'pastry',5,'chocolate croissant','3 ounce',90,1.90),(24,'dessert',5,'tiramisu classico','3 ounce',90,1.90),(25,'dessert',5,'authentic french creme brulee','3 oz',54,5.99),(26,'pie',5,'cappuccino pie','3 pound',10,36.50),(27,'cake',5,'red berry cheesecake','3 pound',12,36.50),(28,'bread',5,'brioche burger buns','4 count',44,4.80),(29,'bread',5,'ciabatta sandwich 6 inch','3 count',28,3.29),(30,'dough',5,'mini blinis','16 count',26,4.46);
...
-- Dump completed on 2021-03-05 22:55:35
